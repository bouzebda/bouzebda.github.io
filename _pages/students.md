...
%\cventry
%{On Discrete Multivariate Time Series}% Role
%{Panagiota TSAMTSIKARI} % Title
%{Universit\'e de Technologie de Compi\`egne} % Location
%{10/2018 --} % Date(s)
%{ \begin{cvitems}
%\item {\textbf{Th\`ese de doctorat} : Co-encadrement ($30\%$) avec Profs. Nikolaos Limnios, Karlis Dimitris. Th\`ese en cotutelle avec Athens University of Economics and Business}
%\end{cvitems}}
