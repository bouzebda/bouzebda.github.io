...
$\psi : \mathbb{R}^{q} \rightarrow \mathbb{R}$.  We focus on the estimation of the location  $\mathbf{ \Theta}$ (mode) of a unique maximum of $m(\cdot, \psi)$ by the location  $ \widehat{\mathbf{ \Theta}}_{\rm T}$  of a maximum of the Nadaraya-Watson kernel estimator $\widehat{m}_{\rm T}(\cdot, \psi)$ for the curve $m(\cdot, \psi)$.
 Within this context, we obtain the consistency with rate  and the asymptotic normality results for $ \widehat{\mathbf{ \Theta}}_{\rm T}$  under mild local smoothness assumptions on $m(\cdot, \psi)$ and the design density $f(\cdot)$ of $\mathbf{ X}$. Beyond ergodicity, any other assumption is
imposed on the data. This paper extends the scope of  some previous results
established under the mixing condition. The usefulness of our results will be illustrated in the construction of confidence regions.
